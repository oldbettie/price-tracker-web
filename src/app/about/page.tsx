                  ...
                  <div className={styles.container}>
                      <div className={styles.contentContainer}>
                          ...
                          <p>
                              ...
                              warranty and the peace of mind that comes with it. However with the increased cost of living I found
                              second hand parts are not as cheap as they used to be and sometimes are the same or more then the parts
                              at general brand new prices. So I started to wait patiently for a good sale to come along before making
                              the purchase. This site will allow you to track the price of the parts you need and notify you when the
                          ...
                          <br/>
                          <p>
                              I believe in full context from the start this will be a paid subscription, I don't know when that will be introduced.
                              I will offer some sort of deal to those that sign up before the model is introduced.
                          </p>
                      </div>
                  </div>
              </div>
